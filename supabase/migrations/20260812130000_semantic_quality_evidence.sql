-- Semantic indexing is only useful when the vectors still describe the rows
-- users can search. Keep queue throughput and correctness evidence separate.
