...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => <div ref={ref} className={cn("propai-card border border-[var(--zone-light-border)] bg-[var(--zone-light-card)] text-[var(--zone-light-text-primary)] shadow-none", className)} {...props} />);
