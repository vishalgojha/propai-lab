              ...
              <div className="px-4 pb-3 grid grid-cols-1 sm:grid-cols-2 gap-1">
                {capabilities.map((cap) => (
                  <div
                    ...
                    className="rounded-md border border-white/5 bg-white/[0.015] px-2 py-1.5"
                  >
                    <div className="flex items-center gap-1.5">
                      <CapIcon name={cap.icon} className="w-3 h-3 text-zinc-400 shrink-0" />
                      <span className="text-[11px] font-medium text-white truncate">{cap.name}</span>
                    ...
                    {(cap.evidence_count !== undefined && cap.evidence_count > 0) && (
                      <div className="flex items-center gap-1 mt-0.5 ml-4.5 text-[10px] tabular-nums text-zinc-500">
