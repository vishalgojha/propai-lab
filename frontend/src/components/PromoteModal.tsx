      ...
      <div className="absolute right-0 top-0 h-full w-full max-w-3xl overflow-y-auto bg-[var(--color-bg-surface)] border-l border-[var(--color-border-strong)] shadow-2xl">
        ...
        <div className="grid gap-5 p-5 lg:grid-cols-[280px_1fr]">
          <div className="space-y-3">
            ...
            <button
              onClick={generate}
              className="w-full rounded-lg bg-[#3EE88A] px-3 py-2 text-sm font-bold text-[#04100a] hover:bg-[#2DC96E]"
            >
              Generate Promotion
            </button>
          </div>
          ...
          <div className="min-w-0 space-y-4">
            <div className="flex flex-wrap gap-2">
              {channels.map((channel) => (
                <button
                  ...
                  className={`rounded-lg px-3 py-1.5 text-sm font-semibold ${active === channel.id ? "bg-[#3EE88A] text-[#04100a]" : "border border-[var(--color-border-strong)] text-[var(--color-text-secondary)] hover:bg-[var(--color-bg-hover)]"}`}
                >
                  {channel.label}
                </button>
              ))}
            ...
            <div className="flex flex-wrap gap-2 border-t border-[var(--color-border)] pt-4">
              ...
              {config?.meta_publish_available && (
                <button className="rounded-lg bg-[#3EE88A] px-3 py-2 text-sm font-bold text-[#04100a]">Publish</button>
              )}
            </div>
