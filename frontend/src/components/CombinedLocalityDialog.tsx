...
export function CombinedLocalityDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-[#0d1117] border border-[rgba(255,255,255,0.1)] rounded-xl w-full max-w-md max-h-[80vh] flex flex-col overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-[rgba(255,255,255,0.08)]">
          <div>
            <h3 className="text-lg font-semibold text-[#e2e8f0]">Combined Localities</h3>
            <p className="text-sm text-[#64748b]">Observed: <span className="text-[#e2e8f0] font-mono">"{surfaceText}"</span></p>
          </div>
          <button
            onClick={onClose}
            className="p-1 rounded hover:bg-[rgba(255,255,255,0.06)] text-[#64748b] hover:text-[#e2e8f0] transition-colors"
            aria-label="Close"
          >
        ...
        <div className="p-4 border-b border-[rgba(255,255,255,0.08)]">
          <input
            ...
            className="w-full bg-[#090d12] border border-[rgba(255,255,255,0.08)] rounded-lg px-3 py-2 text-[#e2e8f0] placeholder-[#4a5568] outline-none focus:border-emerald-500/40 transition-colors"
            autoFocus
          />
        </div>
              ...
              <label
                ...
                className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer transition-colors ${
                  selectedLocalities.has(loc.name)
                    ...
                    : "bg-[#090d12] border border-[rgba(255,255,255,0.04)] hover:border-[rgba(255,255,255,0.08)]"
                }`}
              >
                <input
                  type="checkbox"
                ...
                />
                <span className="font-medium text-[#e2e8f0] flex-1 text-left">{loc.name}</span>
                {loc.count && (
                  <span className="text-xs text-[#64748b] bg-[rgba(255,255,255,0.04)] px-2 py-0.5 rounded">
        ...
        {/* Footer */}
        <div className="flex items-center justify-end gap-3 p-4 border-t border-[rgba(255,255,255,0.08)]">
          <button
            onClick={onClose}
            className="px-4 py-2 rounded-lg text-sm font-medium bg-[rgba(255,255,255,0.04)] text-[#94a3b8] hover:bg-[rgba(255,255,255,0.08)] hover:text-[#e2e8f0] transition-colors"
          >
            Cancel
          </button>
          <button
