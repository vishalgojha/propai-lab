      ...
      <div className="rounded-2xl border border-[rgba(255,255,255,0.06)] bg-[#0d1117] p-5">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <div className="text-xs text-[#64748b]">Messages that reference this entity.</div>
          </div>
          <Link
        ...
        {loading ? (
          <div className="py-10 text-center text-xs text-[#64748b]">Loading profile...</div>
        ) : results.length === 0 ? (
          <div className="py-10 text-center text-xs text-[#64748b]">{emptyHint}</div>
        ) : (
          <div className="mt-4 space-y-2">
            {results.map((result) => (
              <div
                key={result.id}
                className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#0a0f14] p-4 transition-colors hover:border-[rgba(62,232,138,0.22)]"
              >
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <div className="flex items-center gap-2 text-[10px] text-[#64748b]">
                    <span className="rounded bg-[#111820] px-2 py-0.5 text-[#94a3b8]">
                ...
                <div
                  className="mt-2 text-sm leading-relaxed text-[#e2e8f0]"
