  ...
  return (
    <>
      ...
      {showFullMenu && (
        ...
        >
          <div className="w-60 bg-[#0d1117] border border-[rgba(255,255,255,0.12)] rounded-xl shadow-2xl shadow-black/50 overflow-hidden backdrop-blur-xl">
            {/* Selection Preview */}
            <div className="px-3 py-2 border-b border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.02)]">
              <div className="text-[9px] text-[#64748b] uppercase tracking-wider font-bold mb-0.5">Selected</div>
              <div className="text-[10px] text-[#94a3b8] truncate leading-snug">
            ...
            {/* Footer hint */}
            <div className="px-3 py-1.5 border-t border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.01)]">
              <div className="text-[8px] text-[#4a5568] flex items-center gap-1">
