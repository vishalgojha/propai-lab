...
export default function BrokerPhonePage() {
  ...
  return (
    ...
    >
      {loading ? (
        <div className="rounded-2xl border border-[rgba(255,255,255,0.06)] bg-[#0d1117] p-6 text-center text-xs text-[#64748b]">
          Loading broker profile...
        </div>
      ) : broker ? (
        <div className="rounded-2xl border border-[rgba(255,255,255,0.06)] bg-[#0d1117] p-6">
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <div className="rounded-2xl border border-[rgba(255,255,255,0.06)] bg-[#0d1117] p-5">
            <h2 className="text-sm font-semibold text-[#e2e8f0]">Broker summary</h2>
          ...
          <div className="rounded-2xl border border-[rgba(255,255,255,0.06)] bg-[#0d1117] p-5">
            <h2 className="text-sm font-semibold text-[#e2e8f0]">Recent coverage</h2>
            <div className="mt-2 text-xs text-[#64748b]">The phone number does not yet map to a canonical broker record.</div>
            <div className="mt-4 space-y-2 text-xs text-[#cbd5e1]">
              {summary?.markets?.length ? (
                ...
                <div className="rounded-lg bg-[#0a0f14] px-3 py-2 text-[#64748b]">
...
function StatCard({ label, value }: { label: string; value: string | number }) {
  return (
    <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#0a0f14] p-3">
      <div className="text-lg font-bold text-[#e2e8f0]">{value}</div>
      <div className="mt-1 text-[10px] uppercase tracking-[0.16em] text-[#64748b]">{label}</div>
    </div>
  );
}
