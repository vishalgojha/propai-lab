    ...
    <div className="max-w-3xl">
      ...
      <div className="mt-4 rounded-2xl border border-[rgba(255,255,255,0.06)] bg-[#0d1117] p-8 text-center">
        ...
        <div className="mt-2 text-sm text-[#64748b]">
          Promote a listing from My Inventory or Market Listings.
        </div>
        <div className="mt-5 flex justify-center gap-2">
          <a href="/my/inventory" className="rounded-lg bg-[#3EE88A] px-4 py-2 text-sm font-bold text-[#04100a] no-underline">
            My Inventory
          </a>
          <a href="/extractions" className="rounded-lg border border-[rgba(255,255,255,0.1)] px-4 py-2 text-sm text-[#e2e8f0] no-underline hover:bg-[#111820]">
            Market Listings
          </a>
        </div>
      </div>
