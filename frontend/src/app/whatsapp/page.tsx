...
export default function WhatsAppPage() {
  ...
  return <main className="mx-auto max-w-7xl px-4 pb-12 pt-8 lg:px-7"><h1 className="mb-1 text-2xl font-semibold text-white">WhatsApp</h1><p className="mb-6 text-sm text-zinc-500">Connect numbers, choose groups, and manage your business messaging.</p><GroupedTabs tabs={tabs} active={active} />{active === "business-api" ? <WabaPage /> : <ConnectionCenterPage />}</main>;
}
