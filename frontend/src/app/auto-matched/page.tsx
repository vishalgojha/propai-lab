...
export default function AutoMatchedPage() {
  ...
  return <main className="mx-auto max-w-7xl px-5 py-10 lg:px-8">
    ...
    <div role="note" className="mb-5 rounded-xl border border-amber-500/25 bg-amber-500/8 px-4 py-3 text-sm text-text-muted"><span className="font-semibold text-text-primary">Experimental feature.</span> Auto-match results are not live yet and should not be used as a quality signal until the live matching pipeline is validated.</div>
