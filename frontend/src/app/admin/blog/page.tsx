      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.2fr)_minmax(360px,.8fr)]">
        <form onSubmit={save} className="rounded-2xl border border-[rgba(22,37,43,.14)] bg-[#F6FBF9] p-5 shadow-[0_8px_22px_rgba(22,37,43,.05)]">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <label className="sm:col-span-2"><span className="field-label">Excerpt <span className="normal-case tracking-normal text-[#49615F]">({editor.excerpt.length}/220)</span></span><textarea value={editor.excerpt} maxLength={220} onChange={(e) => update("excerpt", e.target.value)} className="field min-h-20" placeholder="A short summary shown on the journal and in search results." required /></label>
