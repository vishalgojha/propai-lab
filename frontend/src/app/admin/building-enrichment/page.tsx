      ...
      {data && state && (
        <>
          ...
          <section className="mb-4 grid min-w-0 gap-4 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
            <Card className="p-4">
              <div className="mb-4 flex items-start justify-between gap-4"><div className="flex items-center gap-2 font-semibold text-white"><Clock3 className="h-4 w-4 text-cyan-300" />Recent job activity</div><p className="max-w-xs text-right text-[11px] text-zinc-500">Completed means the provider job finished. Locality is shown only when it was confirmed.</p></div>
