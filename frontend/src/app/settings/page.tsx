  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="bg-[#0d1117] border border-[rgba(255,255,255,0.06)] rounded-2xl p-5">
        ...
        <div className="mb-4 rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#090d13] px-4 py-3 text-sm text-[#94a3b8]">
          WhatsApp pairing is now terminal-only. Run <span className="font-semibold text-[#e2e8f0]">propai connect</span> in your terminal to scan the QR there. This page only shows connection status.
        </div>
