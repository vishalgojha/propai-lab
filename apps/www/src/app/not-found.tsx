      ...
      <main className="flex-1 flex items-center justify-center px-4 lg:px-6 py-20">
        <div className="text-center max-w-lg">
          ...
          <p className="text-[15px] lg:text-[17px] text-zinc-400 mb-8">
            ...
            been rented, removed, or never existed. Try searching the live inventory instead.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/search"
              className="inline-flex items-center gap-2 px-6 py-3 bg-green-400 text-[#FAF7F0] text-sm font-semibold rounded-lg hover:bg-green-300 transition-colors"
            >
