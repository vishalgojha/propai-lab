...
export async function getListingById(id: number, requestedSlug?: string): Promise<ListingDetail | null> {
  ...
  const detailSelectByCard: Record<string, string> = {
    ...
    commercial_sale: "commercial_use_type,carpet_area_sqft,built_up_area_sqft,chargeable_area_sqft,saleable_area_sqft,area_raw_text,car_parking_count,parking_type,floor_level,floor_range,building_amenities,fitout_status,ceiling_height,occupancy_status,has_lift,has_power_backup,workstation_count,cabin_count,director_cabin_count,ceo_cabin_present,manager_cabin_count,conference_room_count,meeting_room_count,server_room,storage_area,reception_area,pantry_type,washroom_count,cafeteria_seat_count,power_load_kw,rent_per_sqft,price_basis,brokerage_type,developer_name",
    commercial_rent: "commercial_use_type,carpet_area_sqft,built_up_area_sqft,chargeable_area_sqft,area_raw_text,deposit_amount,deposit_months,car_parking_count,parking_type,floor_level,floor_range,building_amenities,fitout_status,ceiling_height,has_lift,has_power_backup,workstation_count,cabin_count,director_cabin_count,ceo_cabin_present,manager_cabin_count,conference_room_count,meeting_room_count,server_room,storage_area,reception_area,pantry_type,washroom_count,cafeteria_seat_count,power_load_kw,rent_per_sqft,price_basis,lease_term_type,lock_in_period_months,notice_period_months,brokerage_type",
  };
