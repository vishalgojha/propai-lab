  ...
  return <div className="www-shell min-h-screen">
    ...
    <main id="main-content">
      <ShortlistProvider>
        ...
        <section className="mp-final-cta"><div className="mp-container mp-final-card"><div><p className="mp-label">Your next move</p><h2>Looking for something specific?</h2><p>Tell us the city, locality, budget, BHK, or the small detail that makes a place feel right.</p></div><div className="mp-final-actions"><Link href="#search" className="mp-primary-cta">Search again <ArrowUpRight aria-hidden="true" /></Link><Link href="/contact" className="mp-secondary-cta"><Send aria-hidden="true" /> Send a WhatsApp enquiry</Link></div></div></section>
        <ShortlistBar />
      </ShortlistProvider>
    </main>
    <SiteFooter />
