...
import { deviceAuthorizeHandler, oauthAuthorizationServerMetadata, oauthAuthorizeGetHandler, oauthAuthorizePostHandler, oauthProtectedResourceMetadata, oauthRegisterHandler, oauthTokenHandler, setMcpUnauthorizedHeaders, } from "./oauth.js";
...
app.use("/assets", express.static("public", { immutable: true, maxAge: "30d" }));
