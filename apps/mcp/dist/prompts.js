...
export function registerMcpPrompts(server) {
    server.registerPrompt("stale_lead_reactivation", {
    ...
    server.registerPrompt("pricing_negotiation_brief", {
    ...
    server.registerPrompt("buyer_to_inventory_match", {
    ...
    server.registerPrompt("match_requirement_to_broker", {
    ...
    server.registerPrompt("draft_growth_asset", {
    ...
    server.registerPrompt("extract_thread_actions", {
    ...
    server.registerPrompt("hot_lead_triage", {
    ...
    server.registerPrompt("daily_activity_review", {
    ...
    server.registerPrompt("match_buyer_to_inventory", {
    ...
    server.registerPrompt("summarise_broker_thread", {
    ...
    server.registerPrompt("price_property", {
    ...
    server.registerPrompt("review_follow_up_queue", {
