...
import routers.ai_chat as _ai_chat_mod
_ai_chat_mod._today_prefix = _today_prefix
...
from routers.ai_chat import _CAPABILITY_SIGNALS, _has_query_signals
...
# ── Self-chat helpers moved to routers/self_chat.py ───────────
...
# ── Send/send-media routes moved to routers/send.py ──────────
...
# ── Public leads route moved to routers/send.py ──────────────
...
# ── Replay route moved to routers/send.py ─────────────────────
...
# ── Business API config routes moved to routers/whatsapp_sync.py ──
...
# ── Webhook routes moved to routers/whatsapp_sync.py ──────────
...
# ── WABA send route moved to routers/whatsapp_sync.py ─────────
...
# ── Business API team routes moved to routers/whatsapp_sync.py ──
...
# ── Sync routes moved to routers/whatsapp_sync.py ─────────────
...
# ── Wire audit helper names into routers.audit ──────────────────────
from routers import audit as _audit_module
_audit_module._group_jid_to_name = _group_jid_to_name
_audit_module._table_exists = _table_exists
_audit_module._audit_rows = _audit_rows
_audit_module._audit_row_value = _audit_row_value
_audit_module._audit_scalar = _audit_scalar
_audit_module._audit_count = _audit_count
_audit_module._audit_timestamp = _audit_timestamp
_audit_module._audit_group_display_name = _audit_group_display_name
_audit_module._audit_buildings_for_group = _audit_buildings_for_group
_audit_module._clean_audit_building_name = _clean_audit_building_name
_audit_module._AUDIT_BUILDING_LABEL_PATTERN = _AUDIT_BUILDING_LABEL_PATTERN
_audit_module._AUDIT_BUILDING_PLACEHOLDERS = _AUDIT_BUILDING_PLACEHOLDERS
_audit_module._count_table = _count_table
_audit_module.parse_group_name = parse_group_name
...
# ── Wire helper names into routers.dashboard ────────────────────
...
# ── Wire helper names into routers.listings ────────────────────
import routers.listings
from pathlib import Path as _Path
routers.listings.MEDIA_DIR = _Path(__file__).resolve().parent / "media" / "listing_photos"
...
# ── Wire auth/org helper names into routers.auth_org ─────────────
...
# ── Wire workspace helper names into routers.workspace ──────────
import routers.workspace
routers.workspace._probe_provider = _probe_provider

# ── Wire whatsapp_sync helper names into routers.whatsapp_sync ──
...
# ── Wire send helper names into routers.send ──────────────────
import routers.send
