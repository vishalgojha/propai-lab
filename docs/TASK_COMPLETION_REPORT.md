...
- Deployment/push: Migration applied to production. The application and new collection worker have not been deployed. Relevant services: `propai-lab:main` and a new `public-collections-worker` Coolify resource. Push status is pending this task.
